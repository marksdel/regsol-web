<html>
	...
	<?php
		...
		if (isset($_REQUEST['staff_training'])) {
			...
			$pdo_dsn='mysql:dbname=r573108_taney_regsol;host=localhost';
			$pdo_user='r573108_taney';     
			$pdo_password='Taney&1';  
			...
			try {
				...
				$con1=mysqli_connect("localhost","r573108_taney","Taney&1","r573108_taney_regsol");
				// Check connection
